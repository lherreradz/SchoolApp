...
var i_49859 = (self__.level + (1));
while(true){
if((i_49859 <= (new_level + (1)))){
(update[i_49859] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_49861 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_49861[i]));
} else {
x__$2.forward.push((((i < links_49861.length))?(links_49861[i]):null));
}

if((i < links_49861.length)){
(links_49861[i] = x__$2);
} else {
links_49861.push(x__$2);
}
...
var i_49867 = (0);
while(true){
if((i_49867 <= self__.level)){
var links_49868 = (update[i_49867]).forward;
if((x__$1 === (((i_49867 < links_49868.length))?(links_49868[i_49867]):null))){
(links_49868[i_49867] = (x__$1.forward[i_49867]));

var G__49869 = (i_49867 + (1));
i_49867 = G__49869;
continue;
} else {
var G__49870 = (i_49867 + (1));
i_49867 = G__49870;
continue;
}
} else {
