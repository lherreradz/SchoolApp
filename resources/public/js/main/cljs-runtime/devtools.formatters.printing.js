...
var len__4864__auto___41424 = arguments.length;
var i__4865__auto___41425 = (0);
while(true){
if((i__4865__auto___41425 < len__4864__auto___41424)){
args__4870__auto__.push((arguments[i__4865__auto___41425]));

var G__41426 = (i__4865__auto___41425 + (1));
i__4865__auto___41425 = G__41426;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq41380){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41381,G__41382,seq41380__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__41386_SHARP_){
return (!((cljs.core.meta(p1__41386_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41407__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e41408){var _e__40238__auto__ = e41408;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e41411){var _e__40238__auto__ = e41411;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__41417 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__41418 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__41418);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41419__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__41417);
}});
...
var temp__5751__auto___41454 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___41454)){
var managed_print_level_41456 = temp__5751__auto___41454;
var _STAR_print_level_STAR__orig_val__41421_41457 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__41422_41458 = managed_print_level_41456;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__41422_41458);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__41420_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__41420_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__41421_41457);
}} else {
job_fn();
}
