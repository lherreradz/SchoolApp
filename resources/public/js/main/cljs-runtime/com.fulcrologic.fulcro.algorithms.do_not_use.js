...
var vec__55392 = ((cljs.core.seq_QMARK_(expr))?cljs.core.ffirst(expr):cljs.core.first(expr));
...
var expr__$1 = (function (){var G__55423 = expr;
if(cljs.core.seq_QMARK_(expr)){
return cljs.core.first(G__55423);
} else {
return G__55423;
}
})();
...
if(cljs.core.seq_QMARK_(expr)){
var G__55439 = cljs.core.first(expr);
return (com.fulcrologic.fulcro.algorithms.do_not_use.join_key.cljs$core$IFn$_invoke$arity$1 ? com.fulcrologic.fulcro.algorithms.do_not_use.join_key.cljs$core$IFn$_invoke$arity$1(G__55439) : com.fulcrologic.fulcro.algorithms.do_not_use.join_key.call(null,G__55439));
} else {
return expr;
...
var len__4864__auto___55488 = arguments.length;
var i__4865__auto___55489 = (0);
while(true){
if((i__4865__auto___55489 < len__4864__auto___55488)){
args__4870__auto__.push((arguments[i__4865__auto___55489]));

var G__55490 = (i__4865__auto___55489 + (1));
i__4865__auto___55489 = G__55490;
continue;
} else {
}
break;
...
/** @this {Function} */
(com.fulcrologic.fulcro.algorithms.do_not_use.deep_merge.cljs$lang$applyTo = (function (seq55453){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq55453));
}));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [["The composed root query is not valid EQL. The app may crash. See `(comp/get-query ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__55478 = query;
var G__55478__$1 = (((G__55478 == null))?null:cljs.core.meta(G__55478));
var G__55478__$2 = (((G__55478__$1 == null))?null:new cljs.core.Keyword(null,"component","component",1555936782).cljs$core$IFn$_invoke$arity$1(G__55478__$1));
if((G__55478__$2 == null)){
return null;
} else {
return (component_name_fn.cljs$core$IFn$_invoke$arity$1 ? component_name_fn.cljs$core$IFn$_invoke$arity$1(G__55478__$2) : component_name_fn.call(null,G__55478__$2));
}
})()),")`"].join(''),query], null);
}),null)),null,849324597,null);
} else {
}
