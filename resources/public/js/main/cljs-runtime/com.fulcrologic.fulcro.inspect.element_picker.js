...
var G__58761 = document.createElement("div");
com.fulcrologic.fulcro.inspect.element_picker.goog$module$goog$object.set(G__58761,"id",id);

goog.dom.appendChild(document.body,G__58761);
...
var G__58764 = document.createElement("div");
com.fulcrologic.fulcro.inspect.element_picker.goog$module$goog$object.set(G__58764,"id",id);

goog.dom.appendChild(document.body,G__58764);
...
var temp__5751__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__58770_SHARP_){
return ((clojure.string.starts_with_QMARK_(p1__58770_SHARP_,"__reactInternalInstance$")) || (clojure.string.starts_with_QMARK_(p1__58770_SHARP_,"__reactFiber$")));
...
com.fulcrologic.fulcro.inspect.element_picker.pick_element = (function com$fulcrologic$fulcro$inspect$element_picker$pick_element(p__58849){
var map__58857 = p__58849;
var map__58857__$1 = cljs.core.__destructure_map(map__58857);
var on_pick = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__58857__$1,new cljs.core.Keyword(null,"on-pick","on-pick",-1995648316),cljs.core.identity);
...
var instance = (function (){var G__58876 = target__$1;
if((G__58876 == null)){
return null;
} else {
return com.fulcrologic.fulcro.inspect.element_picker.react_instance(G__58876);
}
})();
...
var G__58995 = goog.dom.getParentElement(target__$1);
target__$1 = G__58995;
continue;
}
} else {
...
var G__58934_58996 = cljs.core.deref(current);
(on_pick.cljs$core$IFn$_invoke$arity$1 ? on_pick.cljs$core$IFn$_invoke$arity$1(G__58934_58996) : on_pick.call(null,G__58934_58996));
...
var state_map = (function (){var G__58984 = com.fulcrologic.fulcro.components.any__GT_app(comp);
var G__58984__$1 = (((G__58984 == null))?null:new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366).cljs$core$IFn$_invoke$arity$1(G__58984));
if((G__58984__$1 == null)){
return null;
} else {
return cljs.core.deref(G__58984__$1);
}
})();
...
}catch (e58985){var _ = e58985;
return null;
}})(),new cljs.core.Keyword("fulcro.inspect.ui.element","static-query","fulcro.inspect.ui.element/static-query",1120589305),(function (){try{var G__58987 = comp;
var G__58987__$1 = (((G__58987 == null))?null:com.fulcrologic.fulcro.components.react_type(G__58987));
if((G__58987__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.components.get_query.cljs$core$IFn$_invoke$arity$1(G__58987__$1);
}
}catch (e58986){var _ = e58986;
return null;
}})(),new cljs.core.Keyword("fulcro.inspect.ui.element","query","fulcro.inspect.ui.element/query",113020567),(function (){try{var G__58989 = comp;
var G__58989__$1 = (((G__58989 == null))?null:com.fulcrologic.fulcro.components.react_type(G__58989));
if((G__58989__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.components.get_query.cljs$core$IFn$_invoke$arity$2(G__58989__$1,state_map);
}
}catch (e58988){var _ = e58988;
return null;
}})()], null);
});
/**
...
var app_uuid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58990__$1,new cljs.core.Keyword("fulcro.inspect.core","app-uuid","fulcro.inspect.core/app-uuid",-1096445491));
