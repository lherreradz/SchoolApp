...
return cljs.core.vec(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__59330_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(ident,p1__59330_SHARP_);
}),old_list));
});
...
var G__59334 = kw__$1;
var G__59334__$1 = (((G__59334 == null))?null:cljs.core.namespace(G__59334));
if((G__59334__$1 == null)){
return null;
} else {
return cljs.core.re_find(/^ui(?:\.|$)/,G__59334__$1);
}
} else {
return null;
}
...
var mock_missing_object = (function (){var G__59348 = cljs.core.PersistentArrayMap.EMPTY;
var G__59349 = com.fulcrologic.fulcro.algorithms.do_not_use.join_value(element__$1);
return (com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.cljs$core$IFn$_invoke$arity$2(G__59348,G__59349) : com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.call(null,G__59348,G__59349));
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(result__$1,jk,cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (item){
var G__59351 = item;
var G__59352 = com.fulcrologic.fulcro.algorithms.do_not_use.join_value(element__$1);
return (com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.cljs$core$IFn$_invoke$arity$2(G__59351,G__59352) : com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.call(null,G__59351,G__59352));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(result__$1,jk,(function (){var G__59354 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(result__$1,jk);
var G__59355 = com.fulcrologic.fulcro.algorithms.do_not_use.join_value(element__$1);
return (com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.cljs$core$IFn$_invoke$arity$2(G__59354,G__59355) : com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.call(null,G__59354,G__59355));
})());
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(result__$1,result_key,(function (){var G__59356 = cljs.core.PersistentArrayMap.EMPTY;
var G__59357 = com.fulcrologic.fulcro.algorithms.do_not_use.join_value(element__$1);
return (com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.cljs$core$IFn$_invoke$arity$2(G__59356,G__59357) : com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.call(null,G__59356,G__59357));
})());
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__59360){
var vec__59361 = p__59360;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59361,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59361,(1),null);
...
if((((!(com.fulcrologic.fulcro.algorithms.tempid.tempid_QMARK_(m)))) && (cljs.core.map_QMARK_(m)))){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__59365){
var vec__59366 = p__59365;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59366,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59366,(1),null);
if(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.merge","not-found","com.fulcrologic.fulcro.algorithms.merge/not-found",190673437),k)) || (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.merge","not-found","com.fulcrologic.fulcro.algorithms.merge/not-found",190673437),v)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tempids","tempids",1767509089),k)))))){
return acc;
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__59372){
var vec__59373 = p__59372;
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59373,(0),null);
var new_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59373,(1),null);
...
var entity = (function (){var G__59377 = (com.fulcrologic.fulcro.components.get_ident.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.components.get_ident.cljs$core$IFn$_invoke$arity$2(class$,data) : com.fulcrologic.fulcro.components.get_ident.call(null,class$,data));
if((G__59377 == null)){
return null;
} else {
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(state,G__59377);
}
})();
...
var G__59396 = com.fulcrologic.fulcro.algorithms.merge.sweep_merge(updated_state,db);
var G__59396__$1 = (cljs.core.truth_(target)?com.fulcrologic.fulcro.algorithms.data_targeting.process_target.cljs$core$IFn$_invoke$arity$3(G__59396,idnt,target):G__59396);
if(cljs.core.not(target)){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__59396__$1,db,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([idnt], 0));
} else {
return G__59396__$1;
}
} else {
...
var map__59400 = cljs.core.group_by((function (p1__59399_SHARP_){
return cljs.core.vector_QMARK_(cljs.core.first(p1__59399_SHARP_));
}),res);
var map__59400__$1 = cljs.core.__destructure_map(map__59400);
var idents = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59400__$1,true);
var rest = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59400__$1,false);
...
var source_to_merge = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__59402){
var vec__59403 = p__59402;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59403,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59403,(1),null);
...
var ident_joins = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__59406_SHARP_){
var G__59412 = p1__59406_SHARP_;
if(cljs.core.seq_QMARK_(p1__59406_SHARP_)){
return cljs.core.first(G__59412);
} else {
return G__59412;
}
})),cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__59407_SHARP_){
return ((com.fulcrologic.fulcro.algorithms.do_not_use.join_QMARK_(p1__59407_SHARP_)) && (edn_query_language.core.ident_QMARK_(com.fulcrologic.fulcro.algorithms.do_not_use.join_key(p1__59407_SHARP_))));
}))),query);
var step = (function com$fulcrologic$fulcro$algorithms$merge$merge_idents_$_step(result_tree,p__59417){
var vec__59419 = p__59417;
var ident = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59419,(0),null);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59419,(1),null);
...
var vec__59442 = com.fulcrologic.fulcro.algorithms.merge.sift_idents(result_tree);
var idts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59442,(0),null);
var result_tree__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59442,(1),null);
...
var com$fulcrologic$fulcro$algorithms$merge$merge_alternate_unions_$_walk_ast__3 = (function (p__59509,visitor,parent_union){
var map__59510 = p__59509;
var map__59510__$1 = cljs.core.__destructure_map(map__59510);
var parent_ast = map__59510__$1;
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59510__$1,new cljs.core.Keyword(null,"children","children",-940561982));
var component = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59510__$1,new cljs.core.Keyword(null,"component","component",1555936782));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59510__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var dispatch_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59510__$1,new cljs.core.Keyword(null,"dispatch-key","dispatch-key",733619510));
var union_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59510__$1,new cljs.core.Keyword(null,"union-key","union-key",1529707234));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59510__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
var seq__59511 = cljs.core.seq(children);
var chunk__59512 = null;
var count__59513 = (0);
var i__59514 = (0);
while(true){
if((i__59514 < count__59513)){
var ast = chunk__59512.cljs$core$IIndexed$_nth$arity$2(null,i__59514);
...
var G__59680 = seq__59511;
var G__59681 = chunk__59512;
var G__59682 = count__59513;
var G__59683 = (i__59514 + (1));
seq__59511 = G__59680;
chunk__59512 = G__59681;
count__59513 = G__59682;
i__59514 = G__59683;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__59511);
if(temp__5753__auto__){
var seq__59511__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__59511__$1)){
var c__4679__auto__ = cljs.core.chunk_first(seq__59511__$1);
var G__59686 = cljs.core.chunk_rest(seq__59511__$1);
var G__59687 = c__4679__auto__;
var G__59688 = cljs.core.count(c__4679__auto__);
var G__59689 = (0);
seq__59511 = G__59686;
chunk__59512 = G__59687;
count__59513 = G__59688;
i__59514 = G__59689;
continue;
} else {
var ast = cljs.core.first(seq__59511__$1);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(ast),new cljs.core.Keyword(null,"union","union",2142937499))){
com$fulcrologic$fulcro$algorithms$merge$merge_alternate_unions_$_walk_ast.cljs$core$IFn$_invoke$arity$3(ast,visitor,component);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(ast),new cljs.core.Keyword(null,"union-entry","union-entry",223335750))){
...
var G__59693 = cljs.core.next(seq__59511__$1);
var G__59694 = null;
var G__59695 = (0);
var G__59696 = (0);
seq__59511 = G__59693;
chunk__59512 = G__59694;
count__59513 = G__59695;
i__59514 = G__59696;
continue;
}
} else {
...
com$fulcrologic$fulcro$algorithms$merge$merge_alternate_unions_$_walk_ast = function(p__59509,visitor,parent_union){
switch(arguments.length){
case 2:
return com$fulcrologic$fulcro$algorithms$merge$merge_alternate_unions_$_walk_ast__2.call(this,p__59509,visitor);
case 3:
return com$fulcrologic$fulcro$algorithms$merge$merge_alternate_unions_$_walk_ast__3.call(this,p__59509,visitor,parent_union);
}
...
var G__59534 = parent_union;
var G__59535 = cljs.core.PersistentArrayMap.EMPTY;
return (com.fulcrologic.fulcro.components.get_initial_state.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.components.get_initial_state.cljs$core$IFn$_invoke$arity$2(G__59534,G__59535) : com.fulcrologic.fulcro.components.get_initial_state.call(null,G__59534,G__59535));
} else {
return and__4251__auto____$1;
}
} else {
...
if(and__4251__auto____$1){
var G__59536 = component;
var G__59537 = cljs.core.PersistentArrayMap.EMPTY;
return (com.fulcrologic.fulcro.components.get_initial_state.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.components.get_initial_state.cljs$core$IFn$_invoke$arity$2(G__59536,G__59537) : com.fulcrologic.fulcro.components.get_initial_state.call(null,G__59536,G__59537));
} else {
return and__4251__auto____$1;
}
} else {
...
var G__59542 = app__$1;
var G__59543 = cljs.core.PersistentArrayMap.EMPTY;
return (render_BANG_.cljs$core$IFn$_invoke$arity$2 ? render_BANG_.cljs$core$IFn$_invoke$arity$2(G__59542,G__59543) : render_BANG_.call(null,G__59542,G__59543));
} else {
return null;
}
}));
...
var map__59560 = options;
var map__59560__$1 = cljs.core.__destructure_map(map__59560);
var remove_missing_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59560__$1,new cljs.core.Keyword(null,"remove-missing?","remove-missing?",-2044119224));
...
var integrate_params = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__59561){
...
if(cljs.core.truth_((function (){var fexpr__59565 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"replace","replace",-786587770),null,new cljs.core.Keyword(null,"prepend","prepend",342616040),null,new cljs.core.Keyword(null,"append","append",-291298229),null], null), null);
return (fexpr__59565.cljs$core$IFn$_invoke$arity$1 ? fexpr__59565.cljs$core$IFn$_invoke$arity$1(k) : fexpr__59565.call(null,k));
})())){
...
/** @this {Function} */
(com.fulcrologic.fulcro.algorithms.merge.merge_component.cljs$lang$applyTo = (function (seq59545){
...
var G__59548 = cljs.core.first(seq59545__$2);
var seq59545__$3 = cljs.core.next(seq59545__$2);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__59546,G__59547,G__59548,seq59545__$3);
}));
...
while(true){
if((i__4865__auto___59788 < len__4864__auto___59783)){
args__4870__auto__.push((arguments[i__4865__auto___59788]));

var G__59793 = (i__4865__auto___59788 + (1));
i__4865__auto___59788 = G__59793;
continue;
} else {
}
break;
...
var G__59578 = app__$2;
var G__59579 = cljs.core.PersistentArrayMap.EMPTY;
return (render_BANG_.cljs$core$IFn$_invoke$arity$2 ? render_BANG_.cljs$core$IFn$_invoke$arity$2(G__59578,G__59579) : render_BANG_.call(null,G__59578,G__59579));
}
} else {
return null;
}
...
/** @this {Function} */
(com.fulcrologic.fulcro.algorithms.merge.merge_component_BANG_.cljs$lang$applyTo = (function (seq59569){
...
var G__59572 = cljs.core.first(seq59569__$2);
var seq59569__$3 = cljs.core.next(seq59569__$2);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__59570,G__59571,G__59572,seq59569__$3);
}));
