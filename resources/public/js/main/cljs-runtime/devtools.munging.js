...
var o41049 = temp__5751__auto__;
var temp__5751__auto____$1 = (o41049["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o41050 = temp__5751__auto____$1;
return (o41050["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__40197__auto__ = f;
return (o__40197__auto__["toString"]).call(o__40197__auto__);
} else {
return "";
}
}catch (e41060){var _ = e41060;
return "";
}});
...
try{var o__40197__auto___41323 = t;
(o__40197__auto___41323["cljs$lang$ctorPrWriter"]).call(o__40197__auto___41323,t,writer);
}catch (e41070){var __41324 = e41070;
}
...
var char_code = (function (){var o__40197__auto__ = (new String(char$));
return (o__40197__auto__["charCodeAt"]).call(o__40197__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__40197__auto__ = String;
return (o__40197__auto__["fromCharCode"]).call(o__40197__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__41085 = num_code;
switch (G__41085) {
case (1):
return (185);
...
var o__40197__auto__ = String;
return (o__40197__auto__["fromCharCode"]).call(o__40197__auto__,superscript_code);
});
/**
...
}catch (e41092){var _e__40238__auto__ = e41092;
return false;
}})())){
...
var vec__41094 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41094,(0),null);
...
var len__4864__auto___41328 = arguments.length;
var i__4865__auto___41329 = (0);
while(true){
if((i__4865__auto___41329 < len__4864__auto___41328)){
args__4870__auto__.push((arguments[i__4865__auto___41329]));

var G__41330 = (i__4865__auto___41329 + (1));
i__4865__auto___41329 = G__41330;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__41120){
var vec__41121 = p__41120;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41121,(0),null);
...
var G__41332 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__41333 = cljs.core.butlast(remaining_tokens);
name_tokens = G__41332;
remaining_tokens = G__41333;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq41117){
var G__41118 = cljs.core.first(seq41117);
var seq41117__$1 = cljs.core.next(seq41117);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41118,seq41117__$1);
}));
...
var vec__41133 = cljs.core.split_with((function (p1__41128_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__41128_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41133,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41133,(1),null);
...
var vec__41142 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41142,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41142,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__41339 = cljs.core.rest(remaining_tokens);
var G__41340 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__41339;
name_tokens = G__41340;
continue;
} else {
...
var vec__41160 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41160,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41160,(1),null);
var vec__41163 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41163,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41163,(1),null);
var vec__41166 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41166,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41166,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41166,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41166,(3),null);
...
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41182,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41182,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41182,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41182,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41182,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41182,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__41190 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41190,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41190,(1),null);
var vec__41193 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41193,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41193,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__41197 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__41197) : devtools.munging.parse_fn_info_deep.call(null,G__41197));
})()));
}
} else {
return fn_info;
...
var G__41351 = (arity + (1));
var G__41352 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__41209){
var vec__41210 = p__41209;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41210,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41210,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41221_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__41221_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41222_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__41222_SHARP_);
}),sorted_infos);
...
var args__4870__auto__ = [];
var len__4864__auto___41367 = arguments.length;
var i__4865__auto___41368 = (0);
while(true){
if((i__4865__auto___41368 < len__4864__auto___41367)){
args__4870__auto__.push((arguments[i__4865__auto___41368]));

var G__41369 = (i__4865__auto___41368 + (1));
i__4865__auto___41368 = G__41369;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__41232){
var vec__41233 = p__41232;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41233,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq41225){
var G__41226 = cljs.core.first(seq41225);
var seq41225__$1 = cljs.core.next(seq41225);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41226,seq41225__$1);
}));
...
var map__41248 = options;
var map__41248__$1 = cljs.core.__destructure_map(map__41248);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41248__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41248__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41248__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41248__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__41249 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41249,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41249,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41249,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41249,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41249,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41249,(5),null);
...
var o__40197__auto__ = f;
return (o__40197__auto__["getBasis"]).call(o__40197__auto__);
});
/**
...
}catch (e41257){var _e__40238__auto__ = e41257;
...
var G__41373 = (obj[cljs.core.first(path)]);
var G__41374 = cljs.core.rest(path);
obj = G__41373;
path = G__41374;
continue;
} else {
...
var _STAR_ = (function (accum,p__41273){
var vec__41274 = p__41273;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41274,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41274,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__41282){
var vec__41283 = p__41282;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41283,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41283,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41283,(2),null);
...
var post_process = (function (p__41294){
var vec__41295 = p__41294;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41295,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41295,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41290_SHARP_){
return (obj[cljs.core.first(p1__41290_SHARP_)]);
}),sorted_matches);
