...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_44677 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_44677(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_44678 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_44678(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_44679 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_44679(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_44681 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_44681(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_44682 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_44682(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_44683 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_44683(reader);
}
});
...
var G__44721 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__44722 = s.append(c);
c = G__44721;
s = G__44722;
continue;
}
