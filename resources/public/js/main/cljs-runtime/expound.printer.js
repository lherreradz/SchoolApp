...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49732_SHARP_){
return expound.printer.str_width(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__49732_SHARP_,i))));
}),rows));
});
expound.printer.max_row_height = (function expound$printer$max_row_height(row){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49734_SHARP_){
return cljs.core.count(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__49734_SHARP_)));
}),row));
});
...
var G__49739 = ["%-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(column_widths,i)),"s"].join('');
var G__49740 = v;
return (expound.printer.format.cljs$core$IFn$_invoke$arity$2 ? expound.printer.format.cljs$core$IFn$_invoke$arity$2(G__49739,G__49740) : expound.printer.format.call(null,G__49739,G__49740));
}),row);
}),multi_row);
}),multi_rows);
});
...
var columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49751_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__49751_SHARP_)).length),"-"));
}),header);
var header_columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49752_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__49752_SHARP_)).length),"="));
}),header);
...
var iter__4652__auto__ = (function expound$printer$multirow_$_iter__49753(s__49754){
return (new cljs.core.LazySeq(null,(function (){
var s__49754__$1 = s__49754;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__49754__$1);
if(temp__5753__auto__){
var s__49754__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__49754__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__49754__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__49756 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__49755 = (0);
while(true){
if((i__49755 < size__4651__auto__)){
var row_idx = cljs.core._nth(c__4650__auto__,i__49755);
cljs.core.chunk_append(b__49756,(function (){var iter__4652__auto__ = ((function (i__49755,row_idx,c__4650__auto__,size__4651__auto__,b__49756,s__49754__$2,temp__5753__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__49753_$_iter__49763(s__49764){
return (new cljs.core.LazySeq(null,((function (i__49755,row_idx,c__4650__auto__,size__4651__auto__,b__49756,s__49754__$2,temp__5753__auto__,split_row_contents){
return (function (){
...
var c__4650__auto____$1 = cljs.core.chunk_first(s__49764__$2);
var size__4651__auto____$1 = cljs.core.count(c__4650__auto____$1);
var b__49766 = cljs.core.chunk_buffer(size__4651__auto____$1);
if((function (){var i__49765 = (0);
while(true){
if((i__49765 < size__4651__auto____$1)){
var col_idx = cljs.core._nth(c__4650__auto____$1,i__49765);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__49766),expound$printer$multirow_$_iter__49753_$_iter__49763(cljs.core.chunk_rest(s__49764__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__49766),null);
}
} else {
var col_idx = cljs.core.first(s__49764__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__49753_$_iter__49763(cljs.core.rest(s__49764__$2)));
}
} else {
return null;
}
...
});})(i__49755,row_idx,c__4650__auto__,size__4651__auto__,b__49756,s__49754__$2,temp__5753__auto__,split_row_contents))
,null,null));
});})(i__49755,row_idx,c__4650__auto__,size__4651__auto__,b__49756,s__49754__$2,temp__5753__auto__,split_row_contents))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__49756),expound$printer$multirow_$_iter__49753(cljs.core.chunk_rest(s__49754__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__49756),null);
}
} else {
var row_idx = cljs.core.first(s__49754__$2);
return cljs.core.cons((function (){var iter__4652__auto__ = ((function (row_idx,s__49754__$2,temp__5753__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__49753_$_iter__49772(s__49773){
return (new cljs.core.LazySeq(null,(function (){
var s__49773__$1 = s__49773;
while(true){
var temp__5753__auto____$1 = cljs.core.seq(s__49773__$1);
if(temp__5753__auto____$1){
var s__49773__$2 = temp__5753__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__49773__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__49773__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__49775 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__49774 = (0);
while(true){
if((i__49774 < size__4651__auto__)){
var col_idx = cljs.core._nth(c__4650__auto__,i__49774);
cljs.core.chunk_append(b__49775,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__50030 = (i__49774 + (1));
i__49774 = G__50030;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__49775),expound$printer$multirow_$_iter__49753_$_iter__49772(cljs.core.chunk_rest(s__49773__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__49775),null);
}
} else {
var col_idx = cljs.core.first(s__49773__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__49753_$_iter__49772(cljs.core.rest(s__49773__$2)));
}
} else {
return null;
}
...
});})(row_idx,s__49754__$2,temp__5753__auto__,split_row_contents))
;
return iter__4652__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1(cljs.core.count(row)));
})(),expound$printer$multirow_$_iter__49753(cljs.core.rest(s__49754__$2)));
}
} else {
return null;
}
...
var rows = cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [column_keys], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49786_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(p1__49786_SHARP_,column_keys);
}),map_rows));
...
var form = (function (){var G__49824 = via;
var G__49824__$1 = (((G__49824 == null))?null:cljs.core.last(G__49824));
if((G__49824__$1 == null)){
return null;
} else {
return cljs.spec.alpha.form(G__49824__$1);
}
})();
...
var seq__49826_50049 = cljs.core.seq(problems);
var chunk__49827_50050 = null;
var count__49828_50051 = (0);
var i__49829_50052 = (0);
while(true){
if((i__49829_50052 < count__49828_50051)){
var p_50053 = chunk__49827_50050.cljs$core$IIndexed$_nth$arity$2(null,i__49829_50052);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_50053) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__50054 = seq__49826_50049;
var G__50055 = chunk__49827_50050;
var G__50056 = count__49828_50051;
var G__50057 = (i__49829_50052 + (1));
seq__49826_50049 = G__50054;
chunk__49827_50050 = G__50055;
count__49828_50051 = G__50056;
i__49829_50052 = G__50057;
continue;
} else {
var temp__5753__auto___50058 = cljs.core.seq(seq__49826_50049);
if(temp__5753__auto___50058){
var seq__49826_50059__$1 = temp__5753__auto___50058;
if(cljs.core.chunked_seq_QMARK_(seq__49826_50059__$1)){
var c__4679__auto___50061 = cljs.core.chunk_first(seq__49826_50059__$1);
var G__50062 = cljs.core.chunk_rest(seq__49826_50059__$1);
var G__50063 = c__4679__auto___50061;
var G__50064 = cljs.core.count(c__4679__auto___50061);
var G__50065 = (0);
seq__49826_50049 = G__50062;
chunk__49827_50050 = G__50063;
count__49828_50051 = G__50064;
i__49829_50052 = G__50065;
continue;
} else {
var p_50067 = cljs.core.first(seq__49826_50059__$1);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_50067) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__50070 = cljs.core.next(seq__49826_50059__$1);
var G__50071 = null;
var G__50072 = (0);
var G__50073 = (0);
seq__49826_50049 = G__50070;
chunk__49827_50050 = G__50071;
count__49828_50051 = G__50072;
i__49829_50052 = G__50073;
continue;
}
} else {
}
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,k,((cljs.core.qualified_keyword_QMARK_(k))?k:(function (){var or__4253__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__49825_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),cljs.core.name(p1__49825_SHARP_));
}),specs));
...
expound.printer.summarize_key_clause = (function expound$printer$summarize_key_clause(p__49832){
var vec__49833 = p__49832;
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49833,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49833,(1),null);
var G__49836 = branch;
var G__49836__$1 = (((G__49836 instanceof cljs.core.Keyword))?G__49836.fqn:null);
switch (G__49836__$1) {
case "simple":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__49836__$1)].join('')));

}
});
expound.printer.missing_key = (function expound$printer$missing_key(form){
var vec__49837 = cljs.spec.alpha.conform(new cljs.core.Keyword("expound.spec","contains-key-pred","expound.spec/contains-key-pred",-989075236),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,(2)));
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49837,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49837,(1),null);
var G__49840 = branch;
var G__49840__$1 = (((G__49840 instanceof cljs.core.Keyword))?G__49840.fqn:null);
switch (G__49840__$1) {
case "simple":
return new cljs.core.Keyword(null,"kw","kw",1158308175).cljs$core$IFn$_invoke$arity$1(match);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__49840__$1)].join('')));
...
var G__50081 = (i__4865__auto___50079 + (1));
i__4865__auto___50079 = G__50081;
continue;
} else {
}
break;
...
/** @this {Function} */
(expound.printer.format.cljs$lang$applyTo = (function (seq49845){
var G__49846 = cljs.core.first(seq49845);
var seq49845__$1 = cljs.core.next(seq49845);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49846,seq49845__$1);
}));
...
var keys = expound.printer.keywords(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49862_SHARP_){
return expound.printer.missing_key(new cljs.core.Keyword(null,"pred","pred",1927423397).cljs$core$IFn$_invoke$arity$1(p1__49862_SHARP_));
}),problems));
...
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p1__49863_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__49863_SHARP_,"key");
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__49871){
var vec__49872 = p__49871;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49872,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49872,(1),null);
...
var _STAR_print_newline_STAR__orig_val__49880_50089 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__49881_50090 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__49882_50091 = true;
var _STAR_print_fn_STAR__temp_val__49883_50092 = (function (x__4796__auto__){
return sb__4795__auto__.append(x__4796__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__49882_50091);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__49883_50092);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__49881_50090);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__49880_50089);
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49889_SHARP_){
return expound.ansi.color.cljs$core$IFn$_invoke$arity$variadic(p1__49889_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"correct-key","correct-key",1087492967)], 0));
...
var vec__49899 = clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(s));
...
var line = first__49901;
var lines = seq__49900__$1;
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(first_line_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(line)].join('')], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49893_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(rest_lines_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__49893_SHARP_)].join('');
}),lines)));
}));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(displayed_form,new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k)),(function (){var G__49919 = show_valid_values_QMARK_;
var G__49920 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k);
var G__49921 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__49919,G__49920,G__49921) : expound.printer.summary_form.call(null,G__49919,G__49920,G__49921));
})(),new cljs.core.Keyword("expound.problems","irrelevant","expound.problems/irrelevant",2090226124));
} else {
if(((cljs.core.map_QMARK_(form)) && (expound.paths.kvps_QMARK_(k)))){
var G__50111 = show_valid_values_QMARK_;
var G__50112 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(k));
var G__50113 = rst__$1;
show_valid_values_QMARK_ = G__50111;
form = G__50112;
in$ = G__50113;
continue;
} else {
if(cljs.core.associative_QMARK_(form)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(displayed_form,k,(function (){var G__49926 = show_valid_values_QMARK_;
var G__49927 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(form,k);
var G__49928 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__49926,G__49927,G__49928) : expound.printer.summary_form.call(null,G__49926,G__49927,G__49928));
})());
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.seq_QMARK_(form)))){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__49933 = show_valid_values_QMARK_;
var G__49934 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,k);
var G__49935 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__49933,G__49934,G__49935) : expound.printer.summary_form.call(null,G__49933,G__49934,G__49935));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.set_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__49943 = show_valid_values_QMARK_;
var G__49944 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__49945 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__49943,G__49944,G__49945) : expound.printer.summary_form.call(null,G__49943,G__49944,G__49945));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.list_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.List.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__49957 = show_valid_values_QMARK_;
var G__49958 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__49959 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__49957,G__49958,G__49959) : expound.printer.summary_form.call(null,G__49957,G__49958,G__49959));
})()));
} else {
...
var max_width = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49968_SHARP_){
return ((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__49968_SHARP_)).length);
...
var map__49982 = problem;
var map__49982__$1 = cljs.core.__destructure_map(map__49982);
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49982__$1,new cljs.core.Keyword("expound","form","expound/form",-264680632));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49982__$1,new cljs.core.Keyword("expound","in","expound/in",-1900412298));
var map__49983 = opts;
var map__49983__$1 = cljs.core.__destructure_map(map__49983);
var show_valid_values_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__49983__$1,new cljs.core.Keyword(null,"show-valid-values?","show-valid-values?",-587258094),false);
...
var s = (function (){var _STAR_print_namespace_maps_STAR__orig_val__49988 = cljs.core._STAR_print_namespace_maps_STAR_;
var _STAR_print_namespace_maps_STAR__temp_val__49989 = false;
(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__temp_val__49989);
...
}finally {(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__orig_val__49988);
}})();
var vec__49984 = cljs.core.re_find(regex,s);
