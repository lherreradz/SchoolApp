...
var map__41343 = top_item;
var map__41343__$1 = cljs.core.__destructure_map(map__41343);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41343__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41343__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41343__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e41342){var _e = e41342;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5751__auto___41376 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5751__auto___41376)){
var seen_errors_41377 = temp__5751__auto___41376;
if(cljs.core.truth_(seen_errors_41377.has(self))){
} else {
seen_errors_41377.add(self);

var temp__5753__auto___41378 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5753__auto___41378)){
var sense_41379 = temp__5753__auto___41378;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_41379)].join(''));
} else {
}
}
} else {
