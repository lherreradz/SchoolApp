...
var G__41375 = devtools.prefs.pref(v);
v = G__41375;
continue;
} else {
return v;
...
}catch (e41349){var _e__40238__auto__ = e41349;
return false;
}})();
...
}catch (e41353){var _e__40238__auto__ = e41353;
return false;
}})();
...
}catch (e41355){var _e__40238__auto__ = e41355;
return false;
}}
}
});
...
var vec__41364 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41364,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41364,(1),null);
...
return cljs.core.some((function (p1__41370_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__41370_SHARP_);
}),template);
});
