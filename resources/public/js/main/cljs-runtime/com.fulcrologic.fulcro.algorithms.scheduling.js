...
var map__59333 = app__$1;
var map__59333__$1 = cljs.core.__destructure_map(map__59333);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59333__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
...
var raf_59343 = (((typeof requestAnimationFrame !== 'undefined'))?requestAnimationFrame:(function (p1__59336_SHARP_){
return com.fulcrologic.fulcro.algorithms.scheduling.defer(p1__59336_SHARP_,(16));
}));
/**
...
var map__59338 = app__$1;
var map__59338__$1 = cljs.core.__destructure_map(map__59338);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59338__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
if(cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(runtime_atom),scheduled_key))){
return null;
} else {
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(runtime_atom,cljs.core.assoc,scheduled_key,true);
...
return (raf_59343.cljs$core$IFn$_invoke$arity$1 ? raf_59343.cljs$core$IFn$_invoke$arity$1(f) : raf_59343.call(null,f));
}
});
